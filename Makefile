...
LDFLAGS := -ldflags "-s -w -v -X github.com/valksor/go-assern/internal/version.Version=$(VERSION) -X github.com/valksor/go-assern/internal/version.Commit=$(COMMIT) -X github.com/valksor/go-assern/internal/version.BuildTime=$(BUILD_TIME)"
