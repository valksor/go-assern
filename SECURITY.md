...
If you discover a security vulnerability in Assern, please **do not** create a public issue.

Instead, send your report privately:

1. **GitHub Security Advisory** (Recommended):
   - Visit https://github.com/valksor/go-assern/security/advisories
...
2. **Email**:
   ...
   - Include "SECURITY: Assern" in the subject line
...
- **Secure secrets**: Store API keys in environment variables or `.assern/.env` (never commit secrets)
...
- **Secrets management**: API keys stored in `.assern/.env` (gitignored)
...
- **GitHub Security Advisories**: https://github.com/valksor/go-assern/security/advisories

Thank you for helping keep Assern secure!
